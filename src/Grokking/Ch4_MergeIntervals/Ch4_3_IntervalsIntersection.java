...
class Ch4_3_IntervalsIntersection {
    ...
    public static void main(String[] args) {
        ...
        Interval[] result = Ch4_3_IntervalsIntersection.merge(input1, input2);
        ...
        result = Ch4_3_IntervalsIntersection.merge(input1, input2);
        System.out.print("Intervals Intersection: ");
        for (Interval interval : result)
            System.out.print("[" + interval.start + "," + interval.end + "] ");
    }
