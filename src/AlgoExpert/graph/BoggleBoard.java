...
public class BoggleBoard {
    ...
    public static void main(String[] args) {
        ...
        boggleBoard(board, words).forEach(k -> System.out.println(k));
    ...
    private static void explore(int i, int j, char[][] board, TrieNode root, boolean[][] visited, Set<String> finalWords) {
